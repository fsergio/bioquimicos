<?php
class ci_abm_bioquimicos extends bioquimicos_ci {
    ...
    function conf__cuadro(bioquimicos_ei_cuadro $cuadro) {
        if(isset($this->s__filtro)) {
            ...
            $datos=toba::consulta_php('bioquimicos')->get_bioquimicos($where);
        } else {
            $datos=toba::consulta_php('bioquimicos')->get_bioquimicos();
        }
